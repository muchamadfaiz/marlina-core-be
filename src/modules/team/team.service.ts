...
export class TeamService {
  ...
  private mapToResponse(team: any): TeamResponseDto {
    return {
      ...
      pengawasName: team.pengawasName || team.pengawas?.profile?.fullName || team.pengawas?.email || null,
      qcName: team.qcName || null,
      korlapAsn: team.korlapAsn || null,
      nipAsn: team.nipAsn || null,
  ...
  async create(dto: CreateTeamDto) {
    const team = await this.prisma.team.create({
      data: {
        ...
        pengawasName: dto.pengawasName || null,
        qcName: dto.qcName || null,
        korlapAsn: dto.korlapAsn || null,
        nipAsn: dto.nipAsn || null,
  ...
  async update(id: string, dto: UpdateTeamDto) {
    ...
    const team = await this.prisma.team.update({
      ...
      data: {
        ...
        ...(dto.pengawasName !== undefined && { pengawasName: dto.pengawasName || null }),
        ...(dto.qcName !== undefined && { qcName: dto.qcName || null }),
        ...(dto.korlapAsn !== undefined && { korlapAsn: dto.korlapAsn || null }),
        ...(dto.nipAsn !== undefined && { nipAsn: dto.nipAsn || null }),
